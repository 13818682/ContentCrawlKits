# -*- coding: utf-8 -*-
"""QA-003 小红书视频笔记首图（1080×1440 · 3:4 大字版封面）
把「滑档去排名40？不叫滑档」反常识结论 + 「557分」数字对撞放大为视觉主角；13-3 大字版规范。
"""
import numpy as np
...
BASE = "E:/1.HSEE/6.ContentCrawlKits/docs/03-内容创作-深圳中考志愿填报/问答专区/003+中考滑档去了深圳排名40左右的高中怎么办？/03.小红书/01.视频/"
...
put(d, ck, "滑档去了排名40的高中？", font(64, True), (540, 260), color=WHITE, maxw=1000)
put(d, ck, "不叫滑档", font(130, True), (540, 520), color=GOLD, maxw=980)
put(d, ck, "多半是志愿没填好", font(38), (540, 660), color=LIGHT, maxw=1000)
...
put(d, ck, "两条路：接受并规划 · 或复读（慎选）", font(30), (540, 1050), color=LIGHT, maxw=1000)
