# -*- coding: utf-8 -*-
"""S4 小红书封面 精简版（1080×1440，对齐公众号/头条精简理念，D3互补）
深圳中考标识 + 大字主题（白）+ 金线下一句钩子 + 底注。
主题/钩子与公众号精简版同款：体育 50 分，一半靠攒 / 14 分从初一就攒 · 别等考前突击。
"""
...
# ---------- S4 小红书封面 精简版 ----------
im, d = base()
f = put(d, "深圳中考", (W / 2, 170), 96, GOLD, maxw=940, min_size=70, tag="s4x")
bb = d.textbbox((W / 2, 170), "深圳中考", font=f, anchor="mm")
half = (bb[2] - bb[0]) / 2 + 8
d.line([W / 2 - half, 285, W / 2 + half, 285], fill=GOLD, width=8)
f2 = put(d, "体育 50 分，一半靠攒", (W / 2, 560), 122, WHITE, maxw=980, min_size=92, tag="s4x")
bb2 = d.textbbox((W / 2, 560), "体育 50 分，一半靠攒", font=f2, anchor="mm")
half2 = (bb2[2] - bb2[0]) / 2 + 8
d.line([W / 2 - half2, 710, W / 2 + half2, 710], fill=GOLD, width=6)
put(d, "14 分从初一就攒 · 别等考前突击", (W / 2, 860), 60, GOLD, maxw=960, min_size=46, tag="s4x")
put(d, "备考策略 · 收藏不迷路 · 数据见正文", (W / 2, 1360), 26, SUB, bold=False, min_size=20, tag="s4x")
im.save(HERE + "04.小红书/S4-体育三年累积-小红书-封面-精炼版-1080x1440.png")
check("S4 小红书封面 精简版")
print("done")
