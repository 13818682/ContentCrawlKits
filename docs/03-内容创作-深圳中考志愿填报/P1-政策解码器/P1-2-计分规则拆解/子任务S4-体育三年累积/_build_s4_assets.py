...
封面第一眼=深圳中考+问题；数字少用。口径：体育总分50=过程14(体测/参与/通识)+现场36(三类各1项)。
"""
...
f = put(d, "体育 50 分，一半靠攒", (450, 150), 54, WHITE, 900, True, 860, tag="gzh")
bb = d.textbbox((450, 150), "体育 50 分，一半靠攒", font=f, anchor="mm")
d.line([(450 - (bb[2]-bb[0])/2 - 6, 202), (450 + (bb[2]-bb[0])/2 + 6, 202)], fill=GOLD, width=5)
put(d, "14 分从初一攒起 · 别等 4 月", (450, 256), 36, LIGHT, 900, False, 860, tag="gzh")
put(d, "过程分 + 现场考 = 体育 50 分", (450, 330), 34, GOLD, 900, True, 860, tag="gzh")
im.save(HERE + "01.公众号/S4-体育三年累积-公众号-封面-900x383.png")
check("公众号封面")

# ---------- 头条 1200×900 ----------
im, d = base(1200, 900)
pill(d, "深圳中考 · 备考策略", 120, 30, 1200, pad=30)
put(d, "体育 50 分，一半靠攒", (600, 330), 108, WHITE, 1200, True, 1080, tag="tt")
put(d, "14 分从初一攒 · 36 分现场考", (600, 520), 66, GOLD, 1200, True, 1080, tag="tt")
put(d, "别等 4 月才突击｜先查过程分旧账 · 定好三类项目", (600, 670), 40, LIGHT, 1200, False, 1080, tag="tt")
put(d, "数据来源：深圳市教育局公开信息 · 人工核对", (600, 852), 22, SUB, 1200, False, tag="tt")
im.save(HERE + "02.今日头条/S4-体育三年累积-头条-封面-1200x900.png")
check("头条封面")
...
put(d, "体育 50 分", (520, 560), 96, WHITE, 1080, True, 800, tag="dy")
put(d, "一半靠攒，一半靠考", (520, 780), 62, GOLD, 1080, True, 800, tag="dy")
put(d, "14 分从初一攒 · 36 分现场考 · 别等 4 月", (520, 960), 42, LIGHT, 1080, False, 800, tag="dy")
pill(d, "关注我 · 政策解码器继续讲", 1500, 40, 1080, pad=34)
im.save(HERE + "03.抖音/S4-体育三年累积-抖音-首图-1080x1920.png")
...
put(d, "体育 50 分", (540, 500), 132, WHITE, 1080, True, 920, tag="xhs")
put(d, "一半靠攒，一半靠考", (540, 700), 76, GOLD, 1080, True, 920, tag="xhs")
put(d, "14 分从初一攒起 · 别等 4 月才慌", (540, 880), 44, LIGHT, 1080, False, 920, tag="xhs")
put(d, "备考策略 · 收藏不迷路 · 数据见正文", (540, 1280), 28, SUB, 1080, False, tag="xhs")
im.save(HERE + "04.小红书/S4-体育三年累积-小红书-封面-互补版-1080x1440.png")
check("小红书封面")
print("done")
