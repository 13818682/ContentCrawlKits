# -*- coding: utf-8 -*-
"""S2(理化实验涨到20分) 四平台封面/首图
公众号 900×383 + 头条 1200×900 + 抖音首图 1080×1920(安全区) + 小红书 1080×1440。
封面第一眼=深圳中考+问题；数字≤2；等式/原分值(12)不上封面。口径：实验涨到20分、纯操作分。
"""
...
f = put(d, "理化实验，涨到 20 分", (450, 150), 54, WHITE, 900, True, 860, tag="gzh")
bb = d.textbbox((450, 150), "理化实验，涨到 20 分", font=f, anchor="mm")
d.line([(450 - (bb[2]-bb[0])/2 - 6, 202), (450 + (bb[2]-bb[0])/2 + 6, 202)], fill=GOLD, width=5)
put(d, "纯操作分 · 怎么稳稳拿到？", (450, 256), 36, LIGHT, 900, False, 860, tag="gzh")
put(d, "物/化各10分钟 · 现场动手做", (450, 330), 34, GOLD, 900, True, 860, tag="gzh")
im.save(HERE + "01.公众号/S2-理化实验涨到20分-公众号-封面-900x383.png")
check("公众号封面")

# ---------- 头条 1200×900 ----------
im, d = base(1200, 900)
pill(d, "深圳中考 · 备考策略", 120, 30, 1200, pad=30)
put(d, "理化实验，涨到 20 分", (600, 330), 108, WHITE, 1200, True, 1080, tag="tt")
put(d, "纯操作分 · 怎么稳稳拿到？", (600, 520), 70, GOLD, 1200, True, 1080, tag="tt")
put(d, "物化各1个实验 · 各10分钟现场做｜物理电路测量 · 化学气体制取", (600, 670), 40, LIGHT, 1200, False, 1080, tag="tt")
put(d, "数据来源：深圳市教育局公开信息 · 人工核对", (600, 852), 22, SUB, 1200, False, tag="tt")
im.save(HERE + "02.今日头条/S2-理化实验涨到20分-头条-封面-1200x900.png")
check("头条封面")
...
put(d, "理化实验，涨到 20 分", (520, 560), 92, WHITE, 1080, True, 800, tag="dy")
put(d, "这 20 分，靠动手拿", (520, 780), 62, GOLD, 1080, True, 800, tag="dy")
put(d, "物化各1个实验 · 现场做 · 会做才得分", (520, 960), 44, LIGHT, 1080, False, 800, tag="dy")
pill(d, "关注我 · 政策解码器继续讲", 1500, 40, 1080, pad=34)
im.save(HERE + "03.抖音/S2-理化实验涨到20分-抖音-首图-1080x1920.png")
...
put(d, "理化实验", (540, 500), 130, WHITE, 1080, True, 900, tag="xhs")
put(d, "涨到 20 分 · 纯操作分", (540, 700), 76, GOLD, 1080, True, 900, tag="xhs")
put(d, "怎么稳稳拿到？动手练就稳", (540, 880), 44, LIGHT, 1080, False, 900, tag="xhs")
put(d, "备考策略 · 收藏不迷路 · 数据见正文", (540, 1280), 28, SUB, 1080, False, tag="xhs")
im.save(HERE + "04.小红书/S2-理化实验涨到20分-小红书-封面-互补版-1080x1440.png")
check("小红书封面")
print("done")
