...
封面第一眼=深圳中考+问题；数字少用；封面不放争议细节。口径：2026 道法闭卷→开卷、能带纸质材料≠能得分。
"""
...
f = put(d, "道德与法治，改开卷", (450, 150), 54, WHITE, 900, True, 860, tag="gzh")
bb = d.textbbox((450, 150), "道德与法治，改开卷", font=f, anchor="mm")
d.line([(450 - (bb[2]-bb[0])/2 - 6, 202), (450 + (bb[2]-bb[0])/2 + 6, 202)], fill=GOLD, width=5)
put(d, "能带书，≠ 能得分", (450, 256), 36, LIGHT, 900, False, 860, tag="gzh")
put(d, "唯一能带纸质材料进考场的笔试", (450, 330), 34, GOLD, 900, True, 860, tag="gzh")
im.save(HERE + "01.公众号/S3-道德与法治开卷-公众号-封面-900x383.png")
check("公众号封面")

# ---------- 头条 1200×900 ----------
im, d = base(1200, 900)
pill(d, "深圳中考 · 备考策略", 120, 30, 1200, pad=30)
put(d, "道德与法治，改开卷", (600, 330), 108, WHITE, 1200, True, 1080, tag="tt")
put(d, "能带书 ≠ 能得分", (600, 520), 70, GOLD, 1200, True, 1080, tag="tt")
put(d, "唯一能带纸质材料进场｜会翻书 ≠ 会得分·考理解与用材料", (600, 670), 40, LIGHT, 1200, False, 1080, tag="tt")
put(d, "数据来源：深圳市教育局公开信息 · 人工核对", (600, 852), 22, SUB, 1200, False, tag="tt")
im.save(HERE + "02.今日头条/S3-道德与法治开卷-头条-封面-1200x900.png")
check("头条封面")
...
put(d, "道德与法治，改开卷", (520, 560), 92, WHITE, 1080, True, 800, tag="dy")
put(d, "能带书，≠ 能得分", (520, 780), 62, GOLD, 1080, True, 800, tag="dy")
put(d, "唯一能带纸质材料进考场的笔试", (520, 960), 44, LIGHT, 1080, False, 800, tag="dy")
pill(d, "关注我 · 政策解码器继续讲", 1500, 40, 1080, pad=34)
im.save(HERE + "03.抖音/S3-道德与法治开卷-抖音-首图-1080x1920.png")
...
put(d, "道法，改开卷", (540, 520), 128, WHITE, 1080, True, 920, tag="xhs")
put(d, "能带书 ≠ 能得分", (540, 710), 76, GOLD, 1080, True, 920, tag="xhs")
put(d, "唯一能带纸质材料进考场的笔试科目", (540, 880), 46, LIGHT, 1080, False, 920, tag="xhs")
put(d, "备考策略 · 收藏不迷路 · 数据见正文", (540, 1280), 28, SUB, 1080, False, tag="xhs")
im.save(HERE + "04.小红书/S3-道德与法治开卷-小红书-封面-互补版-1080x1440.png")
check("小红书封面")
print("done")
