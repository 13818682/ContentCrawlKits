# -*- coding: utf-8 -*-
"""S3 今日头条封面 精简版（1200×900，对齐公众号精简理念）
深圳中考 pill 保留 + 主题主标题保留放大 + 一句金色钩子（整合原金副题与浅色补充）+ 来源。
钩子句与公众号精简版同款「能带书 ≠ 能得分 · 会查才得分」。
"""
...
f = put(d, "道德与法治，改开卷", (W / 2, 360), 118, WHITE, maxw=1100, min_size=90, tag="s3tt")
bb = d.textbbox((W / 2, 360), "道德与法治，改开卷", font=f, anchor="mm")
half = (bb[2] - bb[0]) / 2 + 6
d.line([W / 2 - half, 480, W / 2 + half, 480], fill=GOLD, width=6)
put(d, "能带书 ≠ 能得分 · 会查才得分", (W / 2, 620), 66, GOLD, maxw=1080, min_size=52, tag="s3tt")
put(d, "数据来源：深圳市教育局公开信息 · 人工核对", (W / 2, 858), 24, SUB, bold=False, min_size=18, tag="s3tt")
im.save(HERE + "02.今日头条/S3-道德与法治开卷-头条-封面-精炼版-1200x900.png")
check("S3 头条封面 精简版")
print("done")
