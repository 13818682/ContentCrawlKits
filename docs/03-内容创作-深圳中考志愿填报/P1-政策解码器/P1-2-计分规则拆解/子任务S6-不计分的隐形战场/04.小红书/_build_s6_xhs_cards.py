...
四卡：正文图1 同分怎么比 / 正文图2 举例说明 / 正文图3 生地已定格 / 正文图4 三件事。
...
center(d, "举例说明 · 某校最后一个名额", (W / 2, 360), 34, LIGHT, bold=False, min_size=27)
# 左右对照卡
cw = (W - 2 * HM - 40) // 2
xc0 = HM; xc1 = HM + cw
...
im.save(HERE + "S6-不计分的隐形战场-小红书-正文图2-举例-1080x1440.png")
check("正文图2")
