...
BASE = "E:/1.HSEE/6.ContentCrawlKits/docs/03-内容创作/SZ深圳/P1-政策解码器/P1-4-投档规则全解/子任务S2-同分PK"
...
if __name__ == "__main__":
    ...
    xc("2-案例", ["生地98 vs 生地90"], ["考生A580 生地98 语数英300", "考生B580 生地90 语数英310", "", "比生地：98＞90 → 考生A先录", "考生B语数英高10分也没用"])
