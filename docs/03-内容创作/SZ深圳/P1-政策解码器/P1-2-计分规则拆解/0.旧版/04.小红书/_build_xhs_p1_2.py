...
D = {
    "video": "E:/1.HSEE/6.ContentCrawlKits/docs/03-内容创作/SZ深圳/P1-政策解码器/P1-2-计分规则拆解/04.小红书/01.视频/",
    "tu": "E:/1.HSEE/6.ContentCrawlKits/docs/03-内容创作/SZ深圳/P1-政策解码器/P1-2-计分规则拆解/04.小红书/02.图文/",
    "long": "E:/1.HSEE/6.ContentCrawlKits/docs/03-内容创作/SZ深圳/P1-政策解码器/P1-2-计分规则拆解/04.小红书/03.长文/",
}
