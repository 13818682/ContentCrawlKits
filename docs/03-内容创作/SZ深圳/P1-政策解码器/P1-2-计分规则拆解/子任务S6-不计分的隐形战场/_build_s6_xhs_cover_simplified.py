# -*- coding: utf-8 -*-
"""S6 小红书封面 精简版（1080×1440，对齐公众号/头条精简理念，D3互补）
...
# ---------- S6 小红书封面 精简版 ----------
im, d = base()
f = put(d, "深圳中考", (W / 2, 170), 96, GOLD, maxw=940, min_size=70, tag="s6x")
bb = d.textbbox((W / 2, 170), "深圳中考", font=f, anchor="mm")
half = (bb[2] - bb[0]) / 2 + 8
d.line([W / 2 - half, 285, W / 2 + half, 285], fill=GOLD, width=8)
f2 = put(d, "生地不计分", (W / 2, 540), 150, WHITE, maxw=980, min_size=112, tag="s6x")
bb2 = d.textbbox((W / 2, 540), "生地不计分", font=f2, anchor="mm")
half2 = (bb2[2] - bb2[0]) / 2 + 8
d.line([W / 2 - half2, 700, W / 2 + half2, 700], fill=GOLD, width=6)
put(d, "却先定录取 · 高 1 分也能定学位", (W / 2, 850), 62, GOLD, maxw=980, min_size=48, tag="s6x")
put(d, "备考策略 · 收藏不迷路 · 数据见正文", (W / 2, 1360), 26, SUB, bold=False, min_size=20, tag="s6x")
im.save(HERE + "04.小红书/S6-不计分的隐形战场-小红书-封面-精炼版-1080x1440.png")
check("S6 小红书封面 精简版")
print("done")
