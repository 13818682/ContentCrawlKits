...
out1 = "E:/1.HSEE/6.ContentCrawlKits/docs/03-内容创作/SZ深圳/S1-基本态势/S1-3-竞争格局全景/05.知乎/03-S1-3-2027深圳中考家长必读：一张图看懂竞争格局-知乎-回答配图-出路全景-1600x900.png"
img.save(out1)
print("已生成:", out1)
...
out2 = "E:/1.HSEE/6.ContentCrawlKits/docs/03-内容创作/SZ深圳/S1-基本态势/S1-3-竞争格局全景/05.知乎/04-S1-3-2027深圳中考家长必读：一张图看懂竞争格局-知乎-想法配图-三组数字-1080x1080.png"
img2.save(out2)
print("已生成:", out2)
print("全部完成")
