...
out1 = "E:/1.HSEE/6.ContentCrawlKits/docs/03-内容创作/SZ深圳/S1-基本态势/S1-5-录取率解读/05.知乎/03-S1-5-公办普高52%录取率意味着什么？2027届家长该知道的3个真相-知乎-回答配图-录取率三层-1600x900.png"
img.save(out1)
print("已生成:", out1)
...
out2 = "E:/1.HSEE/6.ContentCrawlKits/docs/03-内容创作/SZ深圳/S1-基本态势/S1-5-录取率解读/05.知乎/04-S1-5-公办普高52%录取率意味着什么？2027届家长该知道的3个真相-知乎-想法配图-录取率数据-1080x1080.png"
img2.save(out2)
print("已生成:", out2)
print("全部完成")
