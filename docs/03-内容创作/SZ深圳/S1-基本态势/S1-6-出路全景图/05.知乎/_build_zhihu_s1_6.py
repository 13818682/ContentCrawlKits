...
out1 = "E:/1.HSEE/6.ContentCrawlKits/docs/03-内容创作/SZ深圳/S1-基本态势/S1-6-出路全景图/05.知乎/03-S1-6-一张图看懂深圳中考全部出路-知乎-回答配图-4层出路-1600x900.png"
img.save(out1)
print("已生成:", out1)
...
out2 = "E:/1.HSEE/6.ContentCrawlKits/docs/03-内容创作/SZ深圳/S1-基本态势/S1-6-出路全景图/05.知乎/04-S1-6-一张图看懂深圳中考全部出路-知乎-想法配图-4层出路-1080x1080.png"
img2.save(out2)
print("已生成:", out2)
print("全部完成")
