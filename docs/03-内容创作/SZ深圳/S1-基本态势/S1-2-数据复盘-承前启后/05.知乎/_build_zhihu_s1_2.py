...
out1 = "E:/1.HSEE/6.ContentCrawlKits/docs/03-内容创作/SZ深圳/S1-基本态势/S1-2-数据复盘-承前启后/05.知乎/03-S1-2-2026年深圳中考数据复盘：对2027届家长的5个启示-知乎-回答配图-5大启示-1600x900.png"
img.save(out1)
print("已生成:", out1)
...
out2 = "E:/1.HSEE/6.ContentCrawlKits/docs/03-内容创作/SZ深圳/S1-基本态势/S1-2-数据复盘-承前启后/05.知乎/04-S1-2-2026年深圳中考数据复盘：对2027届家长的5个启示-知乎-想法配图-4条数据-1080x1080.png"
img2.save(out2)
print("已生成:", out2)
print("全部完成")
