...
out1 = "E:/1.HSEE/6.ContentCrawlKits/docs/03-内容创作/SZ深圳/S1-基本态势/S1-7-备考时间线/05.知乎/03-S1-7-2027年中考家长备考时间线：从今天起每个月要做什么-知乎-回答配图-5阶段时间线-1600x900.png"
img.save(out1)
print("已生成:", out1)
...
out2 = "E:/1.HSEE/6.ContentCrawlKits/docs/03-内容创作/SZ深圳/S1-基本态势/S1-7-备考时间线/05.知乎/04-S1-7-2027年中考家长备考时间线：从今天起每个月要做什么-知乎-想法配图-时间线-1080x1080.png"
img2.save(out2)
print("已生成:", out2)
print("全部完成")
